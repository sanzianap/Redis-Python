...
#la base de donnees
redis.hmset('user:prichicis@gmail.com', {'connexion':1, 'date1':'13h40'})
redis.hmset('user:prichicisanziana@gmail.com', {'connexion':3, 'date1':'13:40', 'date2':'14:40', 'date3':'18:40'})
